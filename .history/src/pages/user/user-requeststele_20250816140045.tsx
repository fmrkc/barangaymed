  ...
  return (
    <>
      <IonHeader>
        <IonToolbar>
          <IonButtons slot="start">
            ...
            <IonButton onClick={() => history.push('/user/dashboard/home')}>
      ...
      <IonTabBar slot="bottom">
        <IonTabButton tab="home" onClick={() => history.push('/user/dashboard/requests')}>
          <IonIcon icon={home} />
          <IonLabel>Home</IonLabel>
        </IonTabButton>
        <IonTabButton tab="user_requests" onClick={() => history.push('/user/dashboard/user_requests')}>
          <IonIcon icon={albums} />
