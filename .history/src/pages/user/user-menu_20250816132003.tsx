  ...
  return (
      <IonTabs>
        ...
        <IonRouterOutlet>
            ...
            <Route path="/user/dashboard/user_requests/user-requestsmeds" component={Medicine_Request_Status} exact />
            <Route path="/user/dashboard/user_requests/user-requeststele" component={Teleconsultation_Request_Status} exact />
