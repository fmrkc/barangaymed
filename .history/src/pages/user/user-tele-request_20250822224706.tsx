                    ...
                    <div>
                      ...
                      <IonItem>
                        ...
                        <IonSelect
                          ...
                          onIonChange={(e) => setFormData({ ...formData, preferredTime: Array.isArray(e.detail.value) ? e.detail.value[0] : e.detail.value || '' })}
                        >
                    ...
                    <div>
                      ...
                      <IonItem>
                        ...
                        <IonSelect
                          ...
                          onIonChange={(e) => setFormData({ ...formData, barangay: Array.isArray(e.detail.value) ? e.detail.value[0] : e.detail.value || '' })}
                        >
