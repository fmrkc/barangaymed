...
const Notifications: React.FC = () => {
  ...
  const loadNotifications = async () => {
    ...
    try {
      const userNotifications =
        await notificationsService.getUserNotificationsOnce(currentUser.uid);
  ...
  const markAsRead = async (notificationId: string) => {
    ...
    try {
      ...
      // No need to reload; realtime listener will update state anyway
    } catch (error) {
      console.error("Error marking notification as read:", error);
      setToastMessage("Failed to update notification status");
      setShowToast(true);
    }
  };
