...
import { bagCheck, person, home, notifications, albums, close } from 'ionicons/icons';
...
const UserRequests: React.FC = () => {
  ...
  // comment: states for modal details
  ...
  // comment: fetch single request details for modal
